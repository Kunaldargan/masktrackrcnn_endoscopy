...
HOME = "./Trainee_Videos/"
VIDEO_NAME="Dr_Gaurav_Varshney_0deg_LeftTilt_endo"
TEST_VIDEO = "Dr_Gaurav_Varshney_0deg_LeftTilt_endo.avi"
save_path = "instances_val_sub_"+ VIDEO_NAME+".json"
...
print(os.path.join(HOME,TEST_VIDEO))
